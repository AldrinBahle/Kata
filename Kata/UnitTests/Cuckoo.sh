...
OUTPUT_FILE="$PROJECT_DIR/UnitTests/Mocks/GeneratedMocks.swift"
...
${PODS_ROOT}/Cuckoo/run generate --testable "Kata" \
--output "${OUTPUT_FILE}" \
"$INPUT_DIR/$(find . -name WelcomeView.swift)" \
"$INPUT_DIR/$(find . -name Destination.swift)" \
